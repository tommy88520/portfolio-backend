...
func main() {
	db, err := gorm.Open(mysql.Open("root:Dev127336@tcp(127.0.0.1:3306)/portfolio?charset=utf8mb4&parseTime=True&loc=Local"), &gorm.Config{})
	if err != nil {
